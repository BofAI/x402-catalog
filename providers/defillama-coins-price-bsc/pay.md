# DefiLlama Token Price API (current / historical / chart) (BSC x402)
...
- FQN: `defillama-coins-price-bsc`
- Gateway base: `https://tm-x402-gateway.bankofai.io/providers/defillama-coins-price-bsc`
- Category: `finance`
...
- `GET /providers/defillama-coins-price-bsc/prices/current/coingecko:bitcoin,coingecko:ethereum`
- `GET /providers/defillama-coins-price-bsc/prices/historical/1700000000/coingecko:bitcoin`
- `GET /providers/defillama-coins-price-bsc/percentage/coingecko:bitcoin`
...
```bash
curl -sS 'https://tm-x402-gateway.bankofai.io/providers/defillama-coins-price-bsc/prices/current/coingecko:bitcoin,coingecko:ethereum'
```

Equivalent route form:

```text
GET https://tm-x402-gateway.bankofai.io/providers/defillama-coins-price-bsc/prices/current/coingecko:bitcoin,coingecko:ethereum
```
