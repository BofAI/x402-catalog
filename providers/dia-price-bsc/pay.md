# DIA Multi-Source Token Price API (BSC x402, Free)
...
- FQN: `dia-price-bsc`
- Gateway base: `https://tm-x402-gateway.bankofai.io/providers/dia-price-bsc`
- Category: `finance`
...
- `GET /providers/dia-price-bsc/v1/quotation/BTC`
- `GET /providers/dia-price-bsc/v1/assetQuotation/Ethereum/0x....`
...
```bash
curl -sS 'https://tm-x402-gateway.bankofai.io/providers/dia-price-bsc/v1/quotation/BTC'
```

Equivalent route form:

```text
GET https://tm-x402-gateway.bankofai.io/providers/dia-price-bsc/v1/quotation/BTC
```
