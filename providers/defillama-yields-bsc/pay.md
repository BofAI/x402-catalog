# DefiLlama Yields / APY API (BSC x402)
...
- FQN: `defillama-yields-bsc`
- Gateway base: `https://tm-x402-gateway.bankofai.io/providers/defillama-yields-bsc`
- Category: `finance`
...
- `GET /providers/defillama-yields-bsc/pools`
- `GET /providers/defillama-yields-bsc/chart/{pool_id}`
...
```bash
curl -sS 'https://tm-x402-gateway.bankofai.io/providers/defillama-yields-bsc/pools'
```

Equivalent route form:

```text
GET https://tm-x402-gateway.bankofai.io/providers/defillama-yields-bsc/pools
```
